...
![Screenshots](http://biotinker.github.io/wego/wego.gif)
...
* Automatic config management with [ingo](https://github.com/biotinker/ingo)
...
```shell
go get -u github.com/biotinker/wego
```
...
0. __With a [Worldweatheronline](http://www.worldweatheronline.com/) account__
    * Worldweatheronline no longer gives out free API keys. [#83](https://github.com/biotinker/wego/issues/83)
    * Update the following `.wegorc` config variables to fit your needs:
    ```
...
* more [backends and frontends](https://github.com/biotinker/wego/wiki/How-to-write-a-new-backend-or-frontend)
* resolve ALL the [issues](https://github.com/biotinker/wego/issues)
* don't forget the [TODOs in the code](https://github.com/biotinker/wego/search?q=TODO&type=Code)
